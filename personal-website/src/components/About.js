           ...
           <div className="container mx-auto flex px-10 py-10 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <h2 className="title-font sm:text-2xl text-1xl mb-4 font-medium text-slate-300 text-gray-600">
                        University of Alberta Computing Science 2024
                    </h2>
                    <p className="mb-8 leading-relaxed text-gray-350">
                        Welcome to my personal portfolio that I made myself, <em>from scratch</em>! As you can see above, I hope to graduate after the winter semester of 2024. 
